...
public class NewBuyProcessor extends TradeEventProcessor {

	NewBuyProcessor(AggregatePositionService aggregatePositionService, TradeEventService tradeEventService) {
