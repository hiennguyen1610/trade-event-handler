...
public class CancelBuyProcessor extends TradeEventProcessor {

	CancelBuyProcessor(AggregatePositionService aggregatePositionService, TradeEventService tradeEventService) {
