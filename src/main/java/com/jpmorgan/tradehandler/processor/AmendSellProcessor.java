...
public class AmendSellProcessor extends TradeEventProcessor {

	AmendSellProcessor(AggregatePositionService aggregatePositionService, TradeEventService tradeEventService) {
