...
public class AmendBuyProcessor extends TradeEventProcessor {

	AmendBuyProcessor(AggregatePositionService aggregatePositionService, TradeEventService tradeEventService) {
