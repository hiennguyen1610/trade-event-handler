 ...
 */
public class CancelSellProcessorTest {
    private TradeEventProcessor processor = ProcessorFactory.processor(Operation.CANCEL, Direction.SELL);
    ...
    public void setUp() throws Exception {
        ...
        // For reverse(): quantity remains no change
        // For apply(): quantity remains no change
        ...
        reversedTradeEvent = new TradeEvent(1111, 1, "AAA", 100, Direction.SELL, "ACC-9999", Operation.CANCEL);
    }

    @Test
    public void reverse_WithNullOfAggregatePosition() throws Exception {
        assertNull(processor.reverse(null, new TradeEvent()));
    }

    @Test
    public void reverse_WithNullOfTradeEvent() throws Exception {
        assertEquals(new AggregatePosition(), processor.reverse(new AggregatePosition(), null));
    }
    ...
    public void reverse_QuantityCheck() throws Exception {
        ...
        assertEquals(0, aggregatePosition.getQuantity());
