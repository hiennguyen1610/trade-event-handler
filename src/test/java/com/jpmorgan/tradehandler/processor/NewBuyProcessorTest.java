 ...
 */
public class NewBuyProcessorTest {
    private TradeEventProcessor processor = ProcessorFactory.processor(Operation.NEW, Direction.BUY);
    ...
    public void setUp() throws Exception {
        ...
        reversedTradeEvent = new TradeEvent(1111, 1, "AAA", 100, Direction.BUY, "ACC-9999", Operation.NEW);
    }
