 ...
 */
public class AmendSellProcessorTest {
    private TradeEventProcessor processor = ProcessorFactory.processor(Operation.AMEND, Direction.SELL);
    ...
    public void setUp() throws Exception {
        ...
        reversedTradeEvent = new TradeEvent(1111, 1, "AAA", 100, Direction.SELL, "ACC-9999", Operation.AMEND);
    }
