 ...
 */
public class AmendBuyProcessorTest {
    private TradeEventProcessor processor = ProcessorFactory.processor(Operation.AMEND, Direction.BUY);
    ...
    public void setUp() throws Exception {
        ...
        // For reverse(): decreased by 100 for reverse()
        // For apply(): quantity incremented by 100
        ...
        reversedTradeEvent = new TradeEvent(1111, 1, "AAA", 100, Direction.BUY, "ACC-9999", Operation.AMEND);
    }
